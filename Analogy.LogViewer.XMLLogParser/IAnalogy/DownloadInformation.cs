...
namespace Analogy.LogViewer.XMLParser.IAnalogy
{
    ...
    {
        protected override string RepositoryURL { get; set; } = "https://api.github.com/repos/Analogy-LogViewer/Analogy.LogViewer.XMLParser";
        ...
        public override string Name { get; set; } = "XML Parser Data Provider";
